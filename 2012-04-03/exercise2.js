...
var bigPool = SIMPLEX_GRID([[-1.25,19.75],[-1,9],[-0.75,0.25]]);
var smallPool = SIMPLEX_GRID([[-47,3.75],[-5.25,10.5],[-0.75,0.25]]);


var basement = STRUCT([basement1,basement2,basement3,basement4,basement5,basement6,basement7,
	basement8,basement9,basement10,basement11,rialzoBigPool,rialzoSmallPool,stairs]);


var borderWall1 = SIMPLEX_GRID([[-1,7],[-0.75,0.25],[-1,3]]);
var borderWall2 = SIMPLEX_GRID([[-1,0.25],[-1,9],[-1,3]]);
var borderWall3 = SIMPLEX_GRID([[-1,0.25],[-10,12],[-1,3]]);
var borderWall4 = SIMPLEX_GRID([[-1.25,7.75],[-21.75,0.25],[-1,3]]);
var borderWall5 = SIMPLEX_GRID([[-8.75,0.25],[-17,4.75],[-1,3]]);
var borderWall6 = SIMPLEX_GRID([[-37.75,13.25],[-15.75,0.25],[-1,3]]);
var borderWall7 = SIMPLEX_GRID([[-50.75,0.25],[-5,10.75],[-1,3]]);
var borderWall8 = SIMPLEX_GRID([[-41.25,9.5],[-5,0.25],[-1,3]]);
var borderWalls = STRUCT([borderWall1,borderWall2,borderWall3,borderWall4,borderWall5,borderWall6,borderWall7,borderWall8]);


var wall1 = SIMPLEX_GRID([[-6.25,20.5],[-15,0.25],[-1,3]]);
var wall2 = SIMPLEX_GRID([[-25,9],[-7.25,0.25],[-1,3]]);
var wall3 = SIMPLEX_GRID([[-37.25,5.25],[-11.5,0.25],[-1,3]]);
var wall4 = SIMPLEX_GRID([[-5,0.75,-0.7,2.3],[-20.5,0.25],[-1,3]]);
var door4 = SIMPLEX_GRID([[-5,-0.75,0.7],[-20.5,0.25],[-1,-2,1]]);
var wall5 = SIMPLEX_GRID([[-6.88,0.25],[-20.75,-0.70,0.3],[-1,3]]);
var door5 = SIMPLEX_GRID([[-6.88,0.25],[-20.75,0.70],[-1,-2,1]]);
var wall6 = SIMPLEX_GRID([[-4.75,0.25],[-17.1,1.2,-0.7,2.85],[-1,3]]);
var door6 = SIMPLEX_GRID([[-4.75,0.25],[-17.1,-1.2,0.7],[-1,-2,1]]);

var walls = STRUCT([wall1,wall2,wall3,wall4,wall5,wall6,door4,door5,door6]);

var glassGrid1 = SIMPLEX_GRID([[0.1],[0.1,-2.8,0.1],[-1,3]]);
var glassGrid2 = SIMPLEX_GRID([[0.1],[-0.1,2.8],[-1,0.1,-2.8,0.1]]);
var glassPanel = SIMPLEX_GRID([[0.1],[-0.1,2.8],[-1,-0.1,2.8]]);
...
var mediumGlassGrid1 = SIMPLEX_GRID([[0.1,-1.675,0.1],[0.1],[-1,3]]);
var mediumGlassGrid2 = SIMPLEX_GRID([[-0.1,1.675],[0.1],[-1,0.1,-2.8,0.1]]);
var mediumGlassPanel = SIMPLEX_GRID([[-0.1,1.675],[0.1],[-1,-0.1,2.8]]);
...
var smallGlassGrid1 = SIMPLEX_GRID([[0.1,-0.8,0.1],[0.1],[-1,3]]);
var smallGlassGrid2 = SIMPLEX_GRID([[-0.1,0.8],[0.1],[-1,0.1,-2.8,0.1]]);
var smallGlassPanel = SIMPLEX_GRID([[-0.1,0.8],[0.1],[-1,-0.1,2.8]]);
...
var smallestGlassGrid1 = SIMPLEX_GRID([[0.1],[0.1,-0.8,0.1],[-1,3]]);
var smallestGlassGrid2 = SIMPLEX_GRID([[0.1],[-0.1,0.8],[-1,0.1,-2.8,0.1]]);
var smallestGlassPanel = SIMPLEX_GRID([[0.1],[-0.1,0.8],[-1,-0.1,2.8]]);
...
var pillars = SIMPLEX_GRID([[-25.9,0.2,-6.05,0.2,-6.3,0.2,-6.05,0.2],
	[-6.9,0.2,-6.8,0.2],[-1,3]]);
...
var benchesSeats = SIMPLEX_GRID([[-6.75,2.2,2.2,2.2,2.2,2.2,2.2,2.2],
	[-14,0.75],[-1.4,0.1]]);
var benches = STRUCT([benchesLegs,benchesSeats]);

var pedestal = SIMPLEX_GRID([[-48,1],[-14.5,1],[-1,0.6]]);

var bigRoof1 = SIMPLEX_GRID([[-24,23],[-4,13],[-1,-3,0.2]]);
var bigRoof2 = SIMPLEX_GRID([[-24,23],[-4,13],[-1,-3.2,0.1]]);
var smallRoof1 = SIMPLEX_GRID([[10],[-13,10],[-1,-3,0.2]]);
var smallRoof2 = SIMPLEX_GRID([[10],[-13,10],[-1,-3.2,0.1]]);
